            ...
            {contactInfo.map((info, index) => (
              ...
              >
                ...
                {info.link ? (
                  <a
                    href={info.link}
                    className="text-muted hover:text-[#8b1e1e] transition-colors duration-300"
                  >
                    {info.content}
                  </a>
                ) : (
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      id="firstName"
                      name="firstName"
                      className="w-full px-4 py-3 rounded-lg border border-border focus:outline-none focus:ring-2 focus:ring-[#8b1e1e] transition-all duration-300"
                      required
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={6}
                    className="w-full px-4 py-3 rounded-lg border border-border focus:outline-none focus:ring-2 focus:ring-[#8b1e1e] transition-all duration-300 resize-none"
                    required
                  />
                </div>
